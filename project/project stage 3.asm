...
savestate:
		...
		mov ax,[bp+4]								;from ip cs flag from stack
...
nextkey:
		...
		call createThread 					; create the thread and insert 
...
insertThread:
		...
		mov [pcb], ax 			; set as next of 0th thread
...
removeThread:
		...
		mov si,[cs:pcb+bx]					;remove the thread after bx
		...
		mov word[cs:pcb+si+2],0				;set it free
