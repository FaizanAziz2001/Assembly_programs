...
create thread:
				...
				mov [cs:pcb+bx +FLAGSSAVE],0x200
				mov [cs:pcb+bx+SSSAVE],cs
				mov [cs:pcb+bx+SPSAVE],bx*512+512
				mov [cs:pcb+bx+CSSAVE],cs
				mov [cs:pcb+bx+IPSAVE],ip

				mov[cs:pcb+bx+AXSAVE],0
				mov[cs:pcb+bx+BXSAVE],0
				mov[cs:pcb+bx+CXSAVE],0
				mov[cs:pcb+bx+DXSAVE],0
				mov[cs:pcb+bx+SISAVE],0
				mov[cs:pcb+bx+DISAVE],0
				mov[cs:pcb+bx+BPSAVE],0
